...
- [1. 目录](#1-目录)
- [2. 配置方式](#2-配置方式)
    - [2.1. 方式一：修改配置文件](#21-方式一修改配置文件)
    - [2.2. 方式二：命令行参数启动](#22-方式二命令行参数启动)
    - [2.3. 方式三：托管在GitHub Actions上，使用GitHub Secrets配置](#23-方式三托管在github-actions上使用github-secrets配置)
- [3. 配置详细信息](#3-配置详细信息)
    ...
    - [3.3. 推送](#33-推送)
        ...
        - [3.3.7. api](#337-api)
        - [3.3.8. placeholder](#338-placeholder)
        - [3.3.9. bodyJsonTemplate](#339-bodyjsontemplate)
...
<a id="markdown-2-配置方式" name="2-配置方式"></a>
## 2. 配置方式

<a id="markdown-21-方式一修改配置文件" name="21-方式一修改配置文件"></a>
### 2.1. 方式一：修改配置文件
...
<a id="markdown-22-方式二命令行参数启动" name="22-方式二命令行参数启动"></a>
### 2.2. 方式二：命令行参数启动
...
<a id="markdown-23-方式三托管在github-actions上使用github-secrets配置" name="23-方式三托管在github-actions上使用github-secrets配置"></a>
### 2.3. 方式三：托管在GitHub Actions上，使用GitHub Secrets配置
...
<a id="markdown-3-配置详细信息" name="3-配置详细信息"></a>
## 3. 配置详细信息
...
<a id="markdown-337-api" name="337-api"></a>
#### 3.3.7. api
...
<a id="markdown-338-placeholder" name="338-placeholder"></a>
#### 3.3.8. placeholder
...
<a id="markdown-339-bodyjsontemplate" name="339-bodyjsontemplate"></a>
#### 3.3.9. bodyJsonTemplate
